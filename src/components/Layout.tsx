...
const Layout = () => {
    ...
    const fetchGitHubData = async (forceRefresh = false) => {
        ...
        const cachedRepos = localStorage.getItem('portfolio_repos_v9');
        const cachedCommits = localStorage.getItem('portfolio_commits_v9');
        const cachedTime = localStorage.getItem('portfolio_cache_time_v9');
        ...
        try {
            const excludedProjects = [
                ...
                'slideseagma', 'arackerman05', 'appjirlah', '-appjirlah', 'uts', 'tik', 'qrcode'
            ];
        ...
        localStorage.setItem('portfolio_repos_v9', JSON.stringify(repoData));
        localStorage.setItem('portfolio_commits_v9', JSON.stringify(commitData));
        localStorage.setItem('portfolio_cache_time_v9', Date.now().toString());
    };
